(function (ATLAS) {
  ...
  const I18N = {
    en: { h_controls: '// CONTROLS', h_output: '// OUTPUT',
      ...
      l_area_w: 'WIDTH (KM)', l_area_h: 'HEIGHT (KM)', l_title: 'TITLE',
      ...
      c_frame: 'FRAME', c_region: 'REGION', c_marker: 'MARKER', t_pick: 'Pick any color',
      l_districts: 'CITY DISTRICTS', lab_off: 'OFF', lab_on: 'ON',
      ...
      l_marker_label: 'LABEL', l_callout: 'CALLOUT', l_connector: 'CONNECTOR', l_underline: 'UNDERLINE', l_marker_shape: 'SHAPE', l_marker_color: 'COLOR', t_marker_default: 'Use map default', b_delete: 'DELETE', b_done: 'DONE',
    ...
    ru: { h_controls: '// УПРАВЛЕНИЕ', h_output: '// ВЫВОД',
      ...
      l_area_w: 'ШИРИНА (КМ)', l_area_h: 'ВЫСОТА (КМ)', l_title: 'ЗАГОЛОВОК',
      ...
      c_frame: 'РАМКА', c_region: 'РЕГИОН', c_marker: 'МАРКЕР', t_pick: 'Выбрать любой цвет',
      l_districts: 'ГОРОДСКИЕ РАЙОНЫ',
      l_markers: 'МАРКЕРЫ', b_add_marker: '+ ДОБАВИТЬ',
      hint_markers: 'Перетащите, чтобы переместить. Нажмите на маркер, чтобы изменить подпись и выноску.',
      l_marker_label: 'ПОДПИСЬ', l_callout: 'ВЫНОСКА', l_connector: 'ЛИНИЯ', l_underline: 'ПОДЧЁРК', l_marker_shape: 'ФОРМА', l_marker_color: 'ЦВЕТ', t_marker_default: 'Цвет карты по умолчанию', b_delete: 'УДАЛИТЬ', b_done: 'ГОТОВО',
    ...
    fr: { h_controls: '// CONTRÔLES', h_output: '// SORTIE',
      ...
      l_area_w: 'LARGEUR (KM)', l_area_h: 'HAUTEUR (KM)', l_title: 'TITRE',
      ...
      c_frame: 'CADRE', c_region: 'RÉGION', c_marker: 'MARQUEUR', t_pick: 'Choisir une couleur',
      l_districts: 'ARRONDISSEMENTS',
      l_markers: 'MARQUEURS', b_add_marker: '+ AJOUTER',
      hint_markers: 'Glissez pour déplacer. Cliquez sur un marqueur pour modifier son libellé et sa bulle.',
      l_marker_label: 'LIBELLÉ', l_callout: 'BULLE', l_connector: 'LIGNE', l_underline: 'SOULIGNÉ', l_marker_shape: 'FORME', l_marker_color: 'COULEUR', t_marker_default: 'Couleur par défaut', b_delete: 'SUPPRIMER', b_done: 'TERMINÉ',
    ...
    de: { h_controls: '// STEUERUNG', h_output: '// AUSGABE',
      ...
      l_area_w: 'BREITE (KM)', l_area_h: 'HÖHE (KM)', l_title: 'TITEL',
      ...
      c_frame: 'RAHMEN', c_region: 'REGION', c_marker: 'MARKER', t_pick: 'Beliebige Farbe wählen',
      l_districts: 'STADTBEZIRKE',
      l_markers: 'MARKER', b_add_marker: '+ HINZUFÜGEN',
      hint_markers: 'Zum Verschieben ziehen. Marker anklicken, um Beschriftung und Sprechblase zu bearbeiten.',
      l_marker_label: 'BESCHRIFTUNG', l_callout: 'SPRECHBLASE', l_connector: 'LINIE', l_underline: 'UNTERSTRICH', l_marker_shape: 'FORM', l_marker_color: 'FARBE', t_marker_default: 'Kartenstandard verwenden', b_delete: 'LÖSCHEN', b_done: 'FERTIG',
    ...
    es: { h_controls: '// CONTROLES', h_output: '// SALIDA',
      ...
      l_area_w: 'ANCHO (KM)', l_area_h: 'ALTO (KM)', l_title: 'TÍTULO',
      ...
      c_frame: 'MARCO', c_region: 'REGIÓN', c_marker: 'MARCADOR', t_pick: 'Elegir un color',
      l_districts: 'DISTRITOS',
      l_markers: 'MARCADORES', b_add_marker: '+ AÑADIR',
      hint_markers: 'Arrastra para mover. Haz clic en un marcador para editar su etiqueta y globo.',
      l_marker_label: 'ETIQUETA', l_callout: 'GLOBO', l_connector: 'LÍNEA', l_underline: 'SUBRAYADO', l_marker_shape: 'FORMA', l_marker_color: 'COLOR', t_marker_default: 'Usar color del mapa', b_delete: 'ELIMINAR', b_done: 'LISTO',
    ...
    it: { h_controls: '// CONTROLLI', h_output: '// OUTPUT',
      ...
      l_area_w: 'LARGHEZZA (KM)', l_area_h: 'ALTEZZA (KM)', l_title: 'TITOLO',
      ...
      c_frame: 'CORNICE', c_region: 'REGIONE', c_marker: 'MARCATORE', t_pick: 'Scegli un colore',
      l_districts: 'DISTRETTI',
      l_markers: 'MARCATORI', b_add_marker: '+ AGGIUNGI',
      hint_markers: 'Trascina per spostare. Clicca un marcatore per modificarne etichetta e fumetto.',
      l_marker_label: 'ETICHETTA', l_callout: 'FUMETTO', l_connector: 'LINEA', l_underline: 'SOTTOLINEA', l_marker_shape: 'FORMA', l_marker_color: 'COLORE', t_marker_default: 'Usa colore mappa', b_delete: 'ELIMINA', b_done: 'FATTO',
    ...
    ja: { h_controls: '// コントロール', h_output: '// 出力',
      ...
      l_area_w: '幅 (KM)', l_area_h: '高さ (KM)', l_title: 'タイトル',
      b_render: 'マップを生成', b_export: 'PNG書き出し',
      l_colors: 'マップの色', c_land: '陸地', c_landshade: '陸地の陰', c_water: '水域', c_border: '境界線',
      c_frame: '枠', c_region: '地域', c_marker: 'マーカー', t_pick: '任意の色を選択',
      l_districts: '市区境界',
      l_markers: 'マーカー', b_add_marker: '+ 追加',
      hint_markers: 'ドラッグで移動。マーカーをクリックしてラベルと吹き出しを編集。',
      l_marker_label: 'ラベル', l_callout: '吹き出し', l_connector: '連結線', l_underline: '下線', l_marker_shape: '形状', l_marker_color: '色', t_marker_default: '地図の既定色を使用', b_delete: '削除', b_done: '完了',
      t_crop: '範囲を描いて再トリミング',
    ...
    zh: { h_controls: '// 控制', h_output: '// 输出',
      ...
      l_area_w: '宽度 (公里)', l_area_h: '高度 (公里)', l_title: '标题',
      b_render: '生成地图', b_export: '导出 PNG',
      l_colors: '地图配色', c_land: '陆地', c_landshade: '陆地阴影', c_water: '水域', c_border: '边界',
      c_frame: '边框', c_region: '区域', c_marker: '标记', t_pick: '选择任意颜色',
      l_districts: '城市辖区',
      l_markers: '标记', b_add_marker: '+ 添加标记',
      hint_markers: '拖动以移动。点击标记编辑标签和标注框。',
      l_marker_label: '标签', l_callout: '标注', l_connector: '连接线', l_underline: '下划线', l_marker_shape: '形状', l_marker_color: '颜色', t_marker_default: '使用地图默认色', b_delete: '删除', b_done: '完成',
      t_crop: '框选区域以重新裁剪',
