(function (ATLAS) {
  ...
  const I18N = {
    en: { h_controls: '// CONTROLS', h_output: '// OUTPUT',
      ...
      b_set_image: 'SET IMAGE', b_edit_image: 'EDIT IMAGE', b_remove_image: 'REMOVE', b_cancel: 'CANCEL', hint_image: 'Drag to move · scroll to zoom',
    ...
    ru: { h_controls: '// УПРАВЛЕНИЕ', h_output: '// ВЫВОД',
      ...
      b_set_image: 'ИЗОБРАЖЕНИЕ', b_edit_image: 'ИЗМЕНИТЬ ФОТО', b_remove_image: 'УБРАТЬ', b_cancel: 'ОТМЕНА', hint_image: 'Перетащите · колесо для масштаба',
    ...
    fr: { h_controls: '// CONTRÔLES', h_output: '// SORTIE',
      ...
      b_set_image: 'IMAGE', b_edit_image: 'MODIFIER', b_remove_image: 'RETIRER', b_cancel: 'ANNULER', hint_image: 'Glissez · molette pour zoomer',
    ...
    de: { h_controls: '// STEUERUNG', h_output: '// AUSGABE',
      ...
      b_set_image: 'BILD', b_edit_image: 'BILD ÄNDERN', b_remove_image: 'ENTFERNEN', b_cancel: 'ABBRECHEN', hint_image: 'Ziehen · scrollen zum Zoomen',
    ...
    es: { h_controls: '// CONTROLES', h_output: '// SALIDA',
      ...
      b_set_image: 'IMAGEN', b_edit_image: 'EDITAR IMAGEN', b_remove_image: 'QUITAR', b_cancel: 'CANCELAR', hint_image: 'Arrastra · rueda para zoom',
    ...
    it: { h_controls: '// CONTROLLI', h_output: '// OUTPUT',
      ...
      b_set_image: 'IMMAGINE', b_edit_image: 'MODIFICA IMMAGINE', b_remove_image: 'RIMUOVI', b_cancel: 'ANNULLA', hint_image: 'Trascina · rotella per zoom',
    ...
    ja: { h_controls: '// コントロール', h_output: '// 出力',
      ...
      b_set_image: '画像', b_edit_image: '画像を編集', b_remove_image: '削除', b_cancel: 'キャンセル', hint_image: 'ドラッグで移動・スクロールで拡大',
      t_crop: '範囲を描いて再トリミング',
    ...
    zh: { h_controls: '// 控制', h_output: '// 输出',
      ...
      b_set_image: '设为图片', b_edit_image: '编辑图片', b_remove_image: '移除', b_cancel: '取消', hint_image: '拖动移动·滚轮缩放',
      t_crop: '框选区域以重新裁剪',
