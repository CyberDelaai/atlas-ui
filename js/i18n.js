(function (ATLAS) {
  ...
  const I18N = {
    en: { h_controls: '// CONTROLS', h_output: '// OUTPUT',
      ...
      hint_markers: 'Drag to move. Click a marker to edit its label & callout.',
      l_marker_label: 'LABEL', l_callout: 'CALLOUT', b_delete: 'DELETE', b_done: 'DONE',
    ...
    ru: { h_controls: '// УПРАВЛЕНИЕ', h_output: '// ВЫВОД',
      ...
      l_marker_label: 'ПОДПИСЬ', l_callout: 'ВЫНОСКА', b_delete: 'УДАЛИТЬ', b_done: 'ГОТОВО',
    ...
    fr: { h_controls: '// CONTRÔLES', h_output: '// SORTIE',
      ...
      l_marker_label: 'LIBELLÉ', l_callout: 'BULLE', b_delete: 'SUPPRIMER', b_done: 'TERMINÉ',
    ...
    de: { h_controls: '// STEUERUNG', h_output: '// AUSGABE',
      ...
      l_marker_label: 'BESCHRIFTUNG', l_callout: 'SPRECHBLASE', b_delete: 'LÖSCHEN', b_done: 'FERTIG',
    ...
    es: { h_controls: '// CONTROLES', h_output: '// SALIDA',
      ...
      l_marker_label: 'ETIQUETA', l_callout: 'GLOBO', b_delete: 'ELIMINAR', b_done: 'LISTO',
    ...
    it: { h_controls: '// CONTROLLI', h_output: '// OUTPUT',
      ...
      l_marker_label: 'ETICHETTA', l_callout: 'FUMETTO', b_delete: 'ELIMINA', b_done: 'FATTO',
    ...
    ja: { h_controls: '// コントロール', h_output: '// 出力',
      ...
      l_marker_label: 'ラベル', l_callout: '吹き出し', b_delete: '削除', b_done: '完了',
      t_crop: '範囲を描いて再トリミング',
    ...
    zh: { h_controls: '// 控制', h_output: '// 输出',
      ...
      l_marker_label: '标签', l_callout: '标注', b_delete: '删除', b_done: '完成',
      t_crop: '框选区域以重新裁剪',
