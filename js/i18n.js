(function (ATLAS) {
  ...
  const I18N = {
    en: { h_controls: '// CONTROLS', h_output: '// OUTPUT',
      ...
      l_colors: 'MAP COLORS', c_land: 'LAND', c_water: 'WATER', c_border: 'BORDERS',
    ...
    ru: { h_controls: '// УПРАВЛЕНИЕ', h_output: '// ВЫВОД',
      ...
      l_colors: 'ЦВЕТА КАРТЫ', c_land: 'СУША', c_water: 'ВОДА', c_border: 'ГРАНИЦЫ',
    ...
    fr: { h_controls: '// CONTRÔLES', h_output: '// SORTIE',
      ...
      l_colors: 'COULEURS', c_land: 'TERRE', c_water: 'EAU', c_border: 'FRONTIÈRES',
    ...
    de: { h_controls: '// STEUERUNG', h_output: '// AUSGABE',
      ...
      l_colors: 'KARTENFARBEN', c_land: 'LAND', c_water: 'WASSER', c_border: 'GRENZEN',
    ...
    es: { h_controls: '// CONTROLES', h_output: '// SALIDA',
      ...
      l_colors: 'COLORES', c_land: 'TIERRA', c_water: 'AGUA', c_border: 'FRONTERAS',
    ...
    it: { h_controls: '// CONTROLLI', h_output: '// OUTPUT',
      ...
      l_colors: 'COLORI MAPPA', c_land: 'TERRA', c_water: 'ACQUA', c_border: 'CONFINI',
    ...
    ja: { h_controls: '// コントロール', h_output: '// 出力',
      ...
      l_colors: 'マップの色', c_land: '陸地', c_water: '水域', c_border: '境界線',
    ...
    zh: { h_controls: '// 控制', h_output: '// 输出',
      ...
      l_colors: '地图配色', c_land: '陆地', c_water: '水域', c_border: '边界',
