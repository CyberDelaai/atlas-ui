(function (ATLAS) {
  ...
  const I18N = {
    en: { h_controls: '// CONTROLS', h_output: '// OUTPUT',
      ...
      l_districts: 'CITY DISTRICTS', l_districts_land: 'DISTRICTS: LAND ONLY', lab_off: 'OFF', lab_on: 'ON',
    ...
    ru: { h_controls: '// УПРАВЛЕНИЕ', h_output: '// ВЫВОД',
      ...
      l_districts: 'ГОРОДСКИЕ РАЙОНЫ', l_districts_land: 'РАЙОНЫ: ТОЛЬКО СУША',
    ...
    fr: { h_controls: '// CONTRÔLES', h_output: '// SORTIE',
      ...
      l_districts: 'ARRONDISSEMENTS', l_districts_land: 'QUARTIERS : TERRE SEULE',
    ...
    de: { h_controls: '// STEUERUNG', h_output: '// AUSGABE',
      ...
      l_districts: 'STADTBEZIRKE', l_districts_land: 'BEZIRKE: NUR LAND',
    ...
    es: { h_controls: '// CONTROLES', h_output: '// SALIDA',
      ...
      l_districts: 'DISTRITOS', l_districts_land: 'DISTRITOS: SOLO TIERRA',
    ...
    it: { h_controls: '// CONTROLLI', h_output: '// OUTPUT',
      ...
      l_districts: 'DISTRETTI', l_districts_land: 'DISTRETTI: SOLO TERRA',
    ...
    ja: { h_controls: '// コントロール', h_output: '// 出力',
      ...
      l_districts: '市区境界', l_districts_land: '市区境界：陸地のみ',
    ...
    zh: { h_controls: '// 控制', h_output: '// 输出',
      ...
      l_districts: '城市辖区', l_districts_land: '辖区：仅陆地',
