(function (ATLAS) {
  ...
  const I18N = {
    en: { h_controls: '// CONTROLS', h_output: '// OUTPUT',
      ...
      l_marker_label: 'LABEL', l_connector: 'CONNECTOR', l_underline: 'UNDERLINE', l_marker_shape: 'SHAPE', l_marker_fontsize: 'FONT SIZE', l_marker_color: 'COLOR', t_marker_default: 'Use map default', b_delete: 'DELETE', b_done: 'DONE',
    ...
    ru: { h_controls: '// УПРАВЛЕНИЕ', h_output: '// ВЫВОД',
      ...
      l_marker_label: 'ПОДПИСЬ', l_connector: 'ЛИНИЯ', l_underline: 'ПОДЧЁРК', l_marker_shape: 'ФОРМА', l_marker_fontsize: 'РАЗМЕР ШРИФТА', l_marker_color: 'ЦВЕТ', t_marker_default: 'Цвет карты по умолчанию', b_delete: 'УДАЛИТЬ', b_done: 'ГОТОВО',
    ...
    fr: { h_controls: '// CONTRÔLES', h_output: '// SORTIE',
      ...
      l_marker_label: 'LIBELLÉ', l_connector: 'LIGNE', l_underline: 'SOULIGNÉ', l_marker_shape: 'FORME', l_marker_fontsize: 'TAILLE', l_marker_color: 'COULEUR', t_marker_default: 'Couleur par défaut', b_delete: 'SUPPRIMER', b_done: 'TERMINÉ',
    ...
    de: { h_controls: '// STEUERUNG', h_output: '// AUSGABE',
      ...
      l_marker_label: 'BESCHRIFTUNG', l_connector: 'LINIE', l_underline: 'UNTERSTRICH', l_marker_shape: 'FORM', l_marker_fontsize: 'SCHRIFTGRÖSSE', l_marker_color: 'FARBE', t_marker_default: 'Kartenstandard verwenden', b_delete: 'LÖSCHEN', b_done: 'FERTIG',
    ...
    es: { h_controls: '// CONTROLES', h_output: '// SALIDA',
      ...
      l_marker_label: 'ETIQUETA', l_connector: 'LÍNEA', l_underline: 'SUBRAYADO', l_marker_shape: 'FORMA', l_marker_fontsize: 'TAMAÑO', l_marker_color: 'COLOR', t_marker_default: 'Usar color del mapa', b_delete: 'ELIMINAR', b_done: 'LISTO',
    ...
    it: { h_controls: '// CONTROLLI', h_output: '// OUTPUT',
      ...
      l_marker_label: 'ETICHETTA', l_connector: 'LINEA', l_underline: 'SOTTOLINEA', l_marker_shape: 'FORMA', l_marker_fontsize: 'DIMENSIONE', l_marker_color: 'COLORE', t_marker_default: 'Usa colore mappa', b_delete: 'ELIMINA', b_done: 'FATTO',
    ...
    ja: { h_controls: '// コントロール', h_output: '// 出力',
      ...
      l_marker_label: 'ラベル', l_connector: '連結線', l_underline: '下線', l_marker_shape: '形状', l_marker_fontsize: '文字サイズ', l_marker_color: '色', t_marker_default: '地図の既定色を使用', b_delete: '削除', b_done: '完了',
      t_crop: '範囲を描いて再トリミング',
    ...
    zh: { h_controls: '// 控制', h_output: '// 输出',
      ...
      l_marker_label: '标签', l_connector: '连接线', l_underline: '下划线', l_marker_shape: '形状', l_marker_fontsize: '字号', l_marker_color: '颜色', t_marker_default: '使用地图默认色', b_delete: '删除', b_done: '完成',
      t_crop: '框选区域以重新裁剪',
