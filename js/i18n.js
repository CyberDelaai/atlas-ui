(function (ATLAS) {
  ...
  const I18N = {
    en: { h_controls: '// CONTROLS', h_output: '// OUTPUT',
      ...
      l_marker_label: 'LABEL', l_callout: 'CALLOUT', l_connector: 'CONNECTOR', l_underline: 'UNDERLINE', b_delete: 'DELETE', b_done: 'DONE',
    ...
    ru: { h_controls: '// УПРАВЛЕНИЕ', h_output: '// ВЫВОД',
      ...
      c_frame: 'РАМКА', c_region: 'РЕГИОН', t_pick: 'Выбрать любой цвет',
      ...
      l_marker_label: 'ПОДПИСЬ', l_callout: 'ВЫНОСКА', l_connector: 'ЛИНИЯ', l_underline: 'ПОДЧЁРК', b_delete: 'УДАЛИТЬ', b_done: 'ГОТОВО',
    ...
    fr: { h_controls: '// CONTRÔLES', h_output: '// SORTIE',
      ...
      c_frame: 'CADRE', c_region: 'RÉGION', t_pick: 'Choisir une couleur',
      ...
      l_marker_label: 'LIBELLÉ', l_callout: 'BULLE', l_connector: 'LIGNE', l_underline: 'SOULIGNÉ', b_delete: 'SUPPRIMER', b_done: 'TERMINÉ',
    ...
    de: { h_controls: '// STEUERUNG', h_output: '// AUSGABE',
      ...
      c_frame: 'RAHMEN', c_region: 'REGION', t_pick: 'Beliebige Farbe wählen',
      ...
      l_marker_label: 'BESCHRIFTUNG', l_callout: 'SPRECHBLASE', l_connector: 'LINIE', l_underline: 'UNTERSTRICH', b_delete: 'LÖSCHEN', b_done: 'FERTIG',
    ...
    es: { h_controls: '// CONTROLES', h_output: '// SALIDA',
      ...
      c_frame: 'MARCO', c_region: 'REGIÓN', t_pick: 'Elegir un color',
      ...
      l_marker_label: 'ETIQUETA', l_callout: 'GLOBO', l_connector: 'LÍNEA', l_underline: 'SUBRAYADO', b_delete: 'ELIMINAR', b_done: 'LISTO',
    ...
    it: { h_controls: '// CONTROLLI', h_output: '// OUTPUT',
      ...
      c_frame: 'CORNICE', c_region: 'REGIONE', t_pick: 'Scegli un colore',
      ...
      l_marker_label: 'ETICHETTA', l_callout: 'FUMETTO', l_connector: 'LINEA', l_underline: 'SOTTOLINEA', b_delete: 'ELIMINA', b_done: 'FATTO',
    ...
    ja: { h_controls: '// コントロール', h_output: '// 出力',
      ...
      c_frame: '枠', c_region: '地域', t_pick: '任意の色を選択',
      l_districts: '市区境界',
      l_markers: 'マーカー', b_add_marker: '+ 追加',
      hint_markers: 'ドラッグで移動。マーカーをクリックしてラベルと吹き出しを編集。',
      l_marker_label: 'ラベル', l_callout: '吹き出し', l_connector: '連結線', l_underline: '下線', b_delete: '削除', b_done: '完了',
      t_crop: '範囲を描いて再トリミング',
    ...
    zh: { h_controls: '// 控制', h_output: '// 输出',
      ...
      c_frame: '边框', c_region: '区域', t_pick: '选择任意颜色',
      l_districts: '城市辖区',
      l_markers: '标记', b_add_marker: '+ 添加标记',
      hint_markers: '拖动以移动。点击标记编辑标签和标注框。',
      l_marker_label: '标签', l_callout: '标注', l_connector: '连接线', l_underline: '下划线', b_delete: '删除', b_done: '完成',
      t_crop: '框选区域以重新裁剪',
